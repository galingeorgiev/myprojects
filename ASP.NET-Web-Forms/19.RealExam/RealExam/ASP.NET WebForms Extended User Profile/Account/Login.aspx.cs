    ...
    public partial class Login : Page
    {
        ...
        protected void LogIn(object sender, EventArgs e)
        {
            if (IsValid)
            {
                ...
                IAuthenticationManager manager = new AuthenticationIdentityManager(new IdentityStore(new LibraryDbContext())).Authentication;
                ...
                {
                    ErrorSuccessNotifier.AddErrorMessage("Incorect password");
