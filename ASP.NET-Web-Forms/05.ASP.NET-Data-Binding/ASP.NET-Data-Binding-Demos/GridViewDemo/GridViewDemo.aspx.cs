...
namespace GridViewDemo
{
    public partial class GridViewDemo : System.Web.UI.Page
    {
        ...
        {
            new Customer() { ID=11, FirstName = "Svetlin", LastName = "Nakov", Email = "svetlin@nakov.com", Phone = "0894 77 22 53", IsSenior=true },
            new Customer() { ID=22, FirstName = "Bai", LastName = "Ivan", Email = "bai.ivan@gmail.com", Phone = "0899 555 444" },
            new Customer() { ID=33, FirstName = "Kaka", LastName = "Mara", Email = "kaka.mara@kaval.net", Phone = "095 955 955" }
        };
