...
$(document).ready(function () {
    ...
    var eventControler = (function () {
        function addElementsEvents(persister) {
            ...
            //$('#wrapper').dblclick('#game-state-container table tr td', function (e) {
            //    var currentGameId = $('#game-state-container table').attr('data-game-id');
            //    var currentUnitId = $(this).attr('data-unit-id');
            //    persister.battle.defend(currentGameId, currentUnitId, function () {
            //        ui.showMessage('Defent mode is success.');
            //    }, ui.showErrorMessage);
            //});
        }
